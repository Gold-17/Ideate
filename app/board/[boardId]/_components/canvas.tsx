...
const Canvas = ({ boardId }: CanvasProps) => {
    ...
    const insertLayer = useMutation((
        ...
        layerType: LayerType.Ellipse | LayerType.Note | LayerType.Rectangle | LayerType.Text | LayerType.Triangle,
        position: Point
    ) => {
    ...
    const onLayerPointerDown = useMutation((
        ...
        setCanvasState({ mode: CanvasMode.Translating, current: point });
    }, [camera, canvasState.mode, history, setCanvasState]);
    ...
    const layerIdsToColorSelection = useMemo(() => {
        ...
        for (const user of selections) {
            ...
            for (const layerId of selection) {
                layerIdsToColorSelection[layerId] = connectionToColors(connectionId);
            };
        };
            ...
            >
                ...
                >
                    ...
                    {canvasState.mode === CanvasMode.SelectionNet && canvasState.current != null && (
                        <rect
                          className="fill-red-500/5 stroke-red-500 stroke-1"
